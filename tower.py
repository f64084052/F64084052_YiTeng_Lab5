...
class TowerGroup:
    ...
    def upgrade(self):
        ...
        if(self.selected_tower.level<5):   # 被選取的塔等級小於5
    ...
    def sell(self):
        ...
        if(self.selected_tower == self.selected_tower):
            self.__towers.remove(self.selected_tower)  # 從self.selected_tower刪除被選的塔
            self.selected_tower = None                 # 當有塔被刪除時，沒有塔被選
            self.upgrade_menu = None
